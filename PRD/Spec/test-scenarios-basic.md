...
**Happy Path:**
בודק את התהליך המלא מהתחלה לסוף. הבדיקה נחשבת מוצלחת אם קבצי הפלט מורדים תקינים עם כל הנתונים הנכונים.

**Missing Portfolios:**
בודק טיפול בשגיאות כשחסרים פורטפוליוז. הבדיקה נחשבת מוצלחת אם המערכת מזהה את החסרים, מציגה הודעה ברורה, ומאפשרת העלאה מחדש של Template שמאפסת את תהליך הולידציה.

**File Too Large:**
בודק מגבלות גודל של קבצים. הבדיקה נחשבת מוצלחת אם קובץ מעל 40MB נדחה מיידית עם הודעת שגיאה ברורה.

**Multiple Optimizations:**
בודק עומס של ריבוי אופטימיזציות במקביל. הבדיקה נחשבת מוצלחת אם כל האופטימיזציות שנבחרו רצות ומייצרות את הלשוניות הנכונות.

**Reset:**
בודק ניקוי מלא של המערכת. הבדיקה נחשבת מוצלחת אם לחיצה על Reset מנקה את כל הנתונים ומחזירה את המערכת למצב התחלתי נקי.
